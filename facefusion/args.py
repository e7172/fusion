...
def apply_args(args : Args, apply_state_item : ApplyStateItem) -> None:
	...
	# Handle watermark parameter, converting string to boolean
	watermark_value = args.get('output_video_watermark')
	if isinstance(watermark_value, str):
		if watermark_value.lower() == 'false':
			apply_state_item('output_video_watermark', False)
		else:
			apply_state_item('output_video_watermark', True)
	else:
		apply_state_item('output_video_watermark', True)  # Default to True if not specified
