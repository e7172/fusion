...
def create_output_creation_program() -> ArgumentParser:
	...
	group_output_creation.add_argument('--output-video-watermark', help = wording.get('help.output_video_watermark'), type = str, default = config.get_str_value('output_creation.output_video_watermark', 'true'))
